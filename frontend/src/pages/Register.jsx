    ...
    <div className="flex h-screen w-full font-sans bg-[#0f0f10] text-white">
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-8 bg-[#0f0f10]">
        <div className="max-w-[360px] w-full">
          <h1 className="text-[32px] font-medium mb-2">Sign Up</h1>
          <p className="text-gray-500 mb-8 text-[15px]">Sed ut perspiciatis unde omnis iste <br/> natus error sit voluptatem.</p>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            <div className="flex space-x-4">
              <input
                  ...
                  className="w-1/2 px-5 py-3.5 rounded-[18px] bg-transparent border border-[#2a2a2e] text-white focus:outline-none focus:border-[#b18fff] transition-colors placeholder-gray-600 text-[15px]"
              />
              <input
                  type="text"
          ...
          <div className="mt-8 text-center text-gray-500 text-sm">
            Already have an account? <Link to="/login" className="text-white hover:text-gray-300 font-medium ml-1">Log In</Link>
          </div>
        </div>
      </div>
    </div>
